...
export default function PostComponent(props) {
    ...
    return (
        <div className="post-component  flex items-center w-full" onClick={() => setIsOpen(false) } >
            <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-1/2 items-center">
                <div className="p-6">
